...
public class SelectDeliverySlot {

    private WebDriver driver;
    private String className = "SelectDeliverySlot";
    private String subid = "SH-167";

    // Constructor to initialize WebDriver and set className and subid
    public SelectDeliverySlot(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SelectDeliverySlot test = new SelectDeliverySlot(driver);
        test.runTest();
    }
}
