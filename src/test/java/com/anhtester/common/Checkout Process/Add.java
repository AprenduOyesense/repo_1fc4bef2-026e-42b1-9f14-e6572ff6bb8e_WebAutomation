...
public class AddGiftMessage {

    private WebDriver driver;
    private String className = "AddGiftMessage";
    private String subid = "SH-168";

    // Constructor to initialize WebDriver and set className and subid
    public AddGiftMessage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AddGiftMessage test = new AddGiftMessage(driver);
        test.runTest();
    }
}
