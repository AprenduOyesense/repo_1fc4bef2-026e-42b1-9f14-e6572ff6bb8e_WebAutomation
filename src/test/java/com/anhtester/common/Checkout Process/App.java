...
public class ApplyCouponCode {
    ...
    private String className = "ApplyCouponCode";
    private String subid = "SH-172";

    // Constructor to initialize WebDriver and set className and subid
    public ApplyCouponCode(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ApplyCouponCode test = new ApplyCouponCode(driver);
        test.runTest();
    }
}
