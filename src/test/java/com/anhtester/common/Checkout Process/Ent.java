...
public class EnterShippingInformation {
    ...
    private String className = "EnterShippingInformation";
    private String subid = "SH-175";

    // Constructor to initialize WebDriver and set className and subid
    public EnterShippingInformation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EnterShippingInformation test = new EnterShippingInformation(driver);
        test.runTest();
    }
}
