...
public class VerifyPaymentGatewayIntegration {

    private WebDriver driver;
    private String className = "VerifyPaymentGatewayIntegration";
    private String subid = "SH-361";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyPaymentGatewayIntegration(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyPaymentGatewayIntegration test = new VerifyPaymentGatewayIntegration(driver);
        test.runTest();
    }
}
