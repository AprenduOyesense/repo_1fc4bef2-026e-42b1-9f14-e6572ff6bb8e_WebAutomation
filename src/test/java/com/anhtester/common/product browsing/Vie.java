...
public class ViewProductAvailability {

    private WebDriver driver;
    private String className = "ViewProductAvailability";
    private String subid = "SH-103";

    // Constructor to initialize WebDriver and set className and subid
    public ViewProductAvailability(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewProductAvailability test = new ViewProductAvailability(driver);
        test.runTest();
    }
}
