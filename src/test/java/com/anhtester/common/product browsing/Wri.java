...
public class WriteProductReview {
    ...
    private String className = "WriteProductReview";
    private String subid = "SH-104";

    // Constructor to initialize WebDriver and set className and subid
    public WriteProductReview(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        WriteProductReview test = new WriteProductReview(driver);
        test.runTest();
    }
}
