...
public class WebsiteLoadTime {
    ...
    private String className = "WebsiteLoadTime";
    private String subid = "SH-490";

    // Constructor to initialize WebDriver and set className and subid
    public WebsiteLoadTime(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        WebsiteLoadTime test = new WebsiteLoadTime(driver);
        test.runTest();
    }
}
