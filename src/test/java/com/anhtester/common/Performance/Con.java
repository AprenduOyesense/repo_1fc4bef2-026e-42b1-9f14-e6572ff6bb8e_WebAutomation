...
public class ConductLoadTesting {

    private WebDriver driver;
    private String className = "ConductLoadTesting";
    private String subid = "SH-417";

    // Constructor to initialize WebDriver and set className and subid
    public ConductLoadTesting(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConductLoadTesting test = new ConductLoadTesting(driver);
        test.runTest();
    }
}
