...
public class VerifyWebsiteResponsiveness {

    private WebDriver driver;
    private String className = "VerifyWebsiteResponsiveness";
    private String subid = "SH-254";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyWebsiteResponsiveness(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyWebsiteResponsiveness test = new VerifyWebsiteResponsiveness(driver);
        test.runTest();
    }
}
