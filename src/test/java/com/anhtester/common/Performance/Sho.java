...
public class ShoppingCartFunctionalitySpeed {

    private WebDriver driver;
    private String className = "ShoppingCartFunctionalitySpeed";
    private String subid = "SH-488";

    // Constructor to initialize WebDriver and set className and subid
    public ShoppingCartFunctionalitySpeed(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ShoppingCartFunctionalitySpeed test = new ShoppingCartFunctionalitySpeed(driver);
        test.runTest();
    }
}
