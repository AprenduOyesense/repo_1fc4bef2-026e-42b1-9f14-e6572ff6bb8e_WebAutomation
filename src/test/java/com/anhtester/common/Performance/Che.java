...
public class CheckSystemResponseTime {

    private WebDriver driver;
    private String className = "CheckSystemResponseTime";
    private String subid = "SH-418";

    // Constructor to initialize WebDriver and set className and subid
    public CheckSystemResponseTime(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckSystemResponseTime test = new CheckSystemResponseTime(driver);
        test.runTest();
    }
}
