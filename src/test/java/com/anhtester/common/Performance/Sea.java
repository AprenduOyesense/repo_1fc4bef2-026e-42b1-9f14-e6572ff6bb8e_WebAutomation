...
public class SearchFunctionResponseTime {

    private WebDriver driver;
    private String className = "SearchFunctionResponseTime";
    private String subid = "SH-489";

    // Constructor to initialize WebDriver and set className and subid
    public SearchFunctionResponseTime(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SearchFunctionResponseTime test = new SearchFunctionResponseTime(driver);
        test.runTest();
    }
}
