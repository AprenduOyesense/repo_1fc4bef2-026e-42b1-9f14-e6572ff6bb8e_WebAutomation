...
public class VerifyFooterPrivacyPolicyLink {

    private WebDriver driver;
    private String className = "VerifyFooterPrivacyPolicyLink";
    private String subid = "SH-266";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyFooterPrivacyPolicyLink(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyFooterPrivacyPolicyLink test = new VerifyFooterPrivacyPolicyLink(driver);
        test.runTest();
    }
}
