...
public class ValidateTransactionLogging {

    private WebDriver driver;
    private String className = "ValidateTransactionLogging";
    private String subid = "SH-427";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateTransactionLogging(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateTransactionLogging test = new ValidateTransactionLogging(driver);
        test.runTest();
    }
}
