...
public class CheckReorderNotificationEmail {

    private WebDriver driver;
    private String className = "CheckReorderNotificationEmail";
    private String subid = "SH-431";

    // Constructor to initialize WebDriver and set className and subid
    public CheckReorderNotificationEmail(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckReorderNotificationEmail test = new CheckReorderNotificationEmail(driver);
        test.runTest();
    }
}
