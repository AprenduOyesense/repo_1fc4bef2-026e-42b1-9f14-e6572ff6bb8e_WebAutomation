...
public class VerifyReorderBlockwithStopOrder {

    private WebDriver driver;
    private String className = "VerifyReorderBlockwithStopOrder";
    private String subid = "SH-429";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyReorderBlockwithStopOrder(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyReorderBlockwithStopOrder test = new VerifyReorderBlockwithStopOrder(driver);
        test.runTest();
    }
}
