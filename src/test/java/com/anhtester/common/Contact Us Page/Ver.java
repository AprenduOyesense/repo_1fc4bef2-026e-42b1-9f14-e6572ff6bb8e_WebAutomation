...
public class VerifyContactUsPageForm {

    private WebDriver driver;
    private String className = "VerifyContactUsPageForm";
    private String subid = "SH-282";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyContactUsPageForm(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyContactUsPageForm test = new VerifyContactUsPageForm(driver);
        test.runTest();
    }
}
