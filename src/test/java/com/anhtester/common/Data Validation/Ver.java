...
public class VerifyPromotionCodeInput {

    private WebDriver driver;
    private String className = "VerifyPromotionCodeInput";
    private String subid = "SH-394";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyPromotionCodeInput(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyPromotionCodeInput test = new VerifyPromotionCodeInput(driver);
        test.runTest();
    }
}
