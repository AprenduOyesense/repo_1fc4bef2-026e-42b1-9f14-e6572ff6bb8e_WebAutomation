...
public class ValidateBookAuthorInput {

    private WebDriver driver;
    private String className = "ValidateBookAuthorInput";
    private String subid = "SH-404";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateBookAuthorInput(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateBookAuthorInput test = new ValidateBookAuthorInput(driver);
        test.runTest();
    }
}
