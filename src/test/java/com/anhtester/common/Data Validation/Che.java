...
public class CheckEmailAddressValidation {

    private WebDriver driver;
    private String className = "CheckEmailAddressValidation";
    private String subid = "SH-396";

    // Constructor to initialize WebDriver and set className and subid
    public CheckEmailAddressValidation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckEmailAddressValidation test = new CheckEmailAddressValidation(driver);
        test.runTest();
    }
}
