...
public class ValidateLanguageSupport {

    private WebDriver driver;
    private String className = "ValidateLanguageSupport";
    private String subid = "SH-408";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateLanguageSupport(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateLanguageSupport test = new ValidateLanguageSupport(driver);
        test.runTest();
    }
}
