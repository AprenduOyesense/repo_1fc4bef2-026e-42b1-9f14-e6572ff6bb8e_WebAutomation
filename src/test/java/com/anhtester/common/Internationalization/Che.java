...
public class CheckDateandTimeFormatting {

    private WebDriver driver;
    private String className = "CheckDateandTimeFormatting";
    private String subid = "SH-407";

    // Constructor to initialize WebDriver and set className and subid
    public CheckDateandTimeFormatting(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckDateandTimeFormatting test = new CheckDateandTimeFormatting(driver);
        test.runTest();
    }
}
