...
public class VerifyCurrencyDisplay {

    private WebDriver driver;
    private String className = "VerifyCurrencyDisplay";
    private String subid = "SH-406";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyCurrencyDisplay(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyCurrencyDisplay test = new VerifyCurrencyDisplay(driver);
        test.runTest();
    }
}
