...
public class VerifyCartPageCheckoutButton {

    private WebDriver driver;
    private String className = "VerifyCartPageCheckoutButton";
    private String subid = "SH-320";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyCartPageCheckoutButton(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyCartPageCheckoutButton test = new VerifyCartPageCheckoutButton(driver);
        test.runTest();
    }
}
