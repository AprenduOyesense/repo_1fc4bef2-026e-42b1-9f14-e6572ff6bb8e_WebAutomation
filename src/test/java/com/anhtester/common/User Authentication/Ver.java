...
public class VerifyPasswordRecovery {
    ...
    private String className = "VerifyPasswordRecovery";
    private String subid = "SH-376";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyPasswordRecovery(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyPasswordRecovery test = new VerifyPasswordRecovery(driver);
        test.runTest();
    }
}
