...
public class CreateAccountWithWeakPassword {

    private WebDriver driver;
    private String className = "CreateAccountWithWeakPassword";
    private String subid = "SH-243";

    // Constructor to initialize WebDriver and set className and subid
    public CreateAccountWithWeakPassword(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CreateAccountWithWeakPassword test = new CreateAccountWithWeakPassword(driver);
        test.runTest();
    }
}
