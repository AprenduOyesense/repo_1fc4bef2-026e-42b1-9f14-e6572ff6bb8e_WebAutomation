...
public class VerifyWhatsNewPageSortingOptions {

    private WebDriver driver;
    private String className = "VerifyWhatsNewPageSortingOptions";
    private String subid = "SH-331";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyWhatsNewPageSortingOptions(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyWhatsNewPageSortingOptions test = new VerifyWhatsNewPageSortingOptions(driver);
        test.runTest();
    }
}
