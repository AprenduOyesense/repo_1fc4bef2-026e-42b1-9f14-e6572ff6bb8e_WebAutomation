...
public class AttemptRegistrationwithInvalidEmailAddress {

    private WebDriver driver;
    private String className = "AttemptRegistrationwithInvalidEmailAddress";
    private String subid = "SH-522";

    // Constructor to initialize WebDriver and set className and subid
    public AttemptRegistrationwithInvalidEmailAddress(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AttemptRegistrationwithInvalidEmailAddress test = new AttemptRegistrationwithInvalidEmailAddress(driver);
        test.runTest();
    }
}
