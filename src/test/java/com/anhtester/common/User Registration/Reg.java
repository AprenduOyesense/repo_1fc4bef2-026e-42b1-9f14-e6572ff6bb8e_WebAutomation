...
public class RegisteraNewUser {
    ...
    private String className = "RegisteraNewUser";
    private String subid = "SH-524";

    // Constructor to initialize WebDriver and set className and subid
    public RegisteraNewUser(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        RegisteraNewUser test = new RegisteraNewUser(driver);
        test.runTest();
    }
}
