...
public class ResetRegistrationForm {

    private WebDriver driver;
    private String className = "ResetRegistrationForm";
    private String subid = "SH-521";

    // Constructor to initialize WebDriver and set className and subid
    public ResetRegistrationForm(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ResetRegistrationForm test = new ResetRegistrationForm(driver);
        test.runTest();
    }
}
