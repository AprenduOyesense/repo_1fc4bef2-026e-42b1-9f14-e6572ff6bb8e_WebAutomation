...
public class VerifySearchFunctionality {
    ...
    private String className = "VerifySearchFunctionality";
    private String subid = "SH-369";

    // Constructor to initialize WebDriver and set className and subid
    public VerifySearchFunctionality(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifySearchFunctionality test = new VerifySearchFunctionality(driver);
        test.runTest();
    }
}
