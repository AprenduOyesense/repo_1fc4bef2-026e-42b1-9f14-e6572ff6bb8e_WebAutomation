...
public class BrowseProductsByCategory {
    ...
    private String className = "BrowseProductsByCategory";
    private String subid = "SH-235";

    // Constructor to initialize WebDriver and set className and subid
    public BrowseProductsByCategory(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        BrowseProductsByCategory test = new BrowseProductsByCategory(driver);
        test.runTest();
    }
}
