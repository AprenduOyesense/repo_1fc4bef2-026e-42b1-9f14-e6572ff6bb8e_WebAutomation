...
public class ViewProductWarranty {
    ...
    private String className = "ViewProductWarranty";
    private String subid = "SH-219";

    // Constructor to initialize WebDriver and set className and subid
    public ViewProductWarranty(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewProductWarranty test = new ViewProductWarranty(driver);
        test.runTest();
    }
}
