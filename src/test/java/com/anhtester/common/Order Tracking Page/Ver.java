...
public class VerifyOrderTrackingPageOrderStatus {

    private WebDriver driver;
    private String className = "VerifyOrderTrackingPageOrderStatus";
    private String subid = "SH-306";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyOrderTrackingPageOrderStatus(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyOrderTrackingPageOrderStatus test = new VerifyOrderTrackingPageOrderStatus(driver);
        test.runTest();
    }
}
