...
public class UpdateUserDetails {
    ...
    private String className = "UpdateUserDetails";
    private String subid = "SH-515";

    // Constructor to initialize WebDriver and set className and subid
    public UpdateUserDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UpdateUserDetails test = new UpdateUserDetails(driver);
        test.runTest();
    }
}
