...
public class ViewPurchaseHistory {
    ...
    private String className = "ViewPurchaseHistory";
    private String subid = "SH-512";

    // Constructor to initialize WebDriver and set className and subid
    public ViewPurchaseHistory(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewPurchaseHistory test = new ViewPurchaseHistory(driver);
        test.runTest();
    }
}
