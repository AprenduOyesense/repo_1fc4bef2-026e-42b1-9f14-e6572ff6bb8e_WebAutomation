...
public class VerifyOrderTracking {

    private WebDriver driver;
    private String className = "VerifyOrderTracking";
    private String subid = "SH-247";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyOrderTracking(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyOrderTracking test = new VerifyOrderTracking(driver);
        test.runTest();
    }
}
