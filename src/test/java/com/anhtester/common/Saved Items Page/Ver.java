...
public class VerifySavedItemsPageAddtoCartButton {

    private WebDriver driver;
    private String className = "VerifySavedItemsPageAddtoCartButton";
    private String subid = "SH-288";

    // Constructor to initialize WebDriver and set className and subid
    public VerifySavedItemsPageAddtoCartButton(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifySavedItemsPageAddtoCartButton test = new VerifySavedItemsPageAddtoCartButton(driver);
        test.runTest();
    }
}
