...
public class VerifyFAQsPageSearchFunctionality {

    private WebDriver driver;
    private String className = "VerifyFAQsPageSearchFunctionality";
    private String subid = "SH-285";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyFAQsPageSearchFunctionality(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyFAQsPageSearchFunctionality test = new VerifyFAQsPageSearchFunctionality(driver);
        test.runTest();
    }
}
