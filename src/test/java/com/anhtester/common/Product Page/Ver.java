...
public class VerifyProductPageDeliveryInformation {

    private WebDriver driver;
    private String className = "VerifyProductPageDeliveryInformation";
    private String subid = "SH-340";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyProductPageDeliveryInformation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyProductPageDeliveryInformation test = new VerifyProductPageDeliveryInformation(driver);
        test.runTest();
    }
}
