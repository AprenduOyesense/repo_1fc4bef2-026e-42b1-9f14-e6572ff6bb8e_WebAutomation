...
public class SearchforNonExistentBook {

    private WebDriver driver;
    private String className = "SearchforNonExistentBook";
    private String subid = "SH-529";

    // Constructor to initialize WebDriver and set className and subid
    public SearchforNonExistentBook(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SearchforNonExistentBook test = new SearchforNonExistentBook(driver);
        test.runTest();
    }
}
