...
public class ViewOrderConfirmation {

    private WebDriver driver;
    private String className = "ViewOrderConfirmation";
    private String subid = "SH-503";

    // Constructor to initialize WebDriver and set className and subid
    public ViewOrderConfirmation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewOrderConfirmation test = new ViewOrderConfirmation(driver);
        test.runTest();
    }
}
