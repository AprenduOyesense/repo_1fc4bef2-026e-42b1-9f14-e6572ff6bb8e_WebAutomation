...
public class CheckCartContents {

    private WebDriver driver;
    private String className = "CheckCartContents";
    private String subid = "SH-527";

    // Constructor to initialize WebDriver and set className and subid
    public CheckCartContents(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckCartContents test = new CheckCartContents(driver);
        test.runTest();
    }
}
