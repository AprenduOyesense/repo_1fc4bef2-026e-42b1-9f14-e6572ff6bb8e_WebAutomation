...
public class UpdateProductQuantity {
    ...
    private String className = "UpdateProductQuantity";
    private String subid = "SH-206";

    // Constructor to initialize WebDriver and set className and subid
    public UpdateProductQuantity(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UpdateProductQuantity test = new UpdateProductQuantity(driver);
        test.runTest();
    }
}
