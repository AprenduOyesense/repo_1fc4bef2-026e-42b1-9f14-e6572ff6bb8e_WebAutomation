...
public class VerifyAddItemtoCart {

    private WebDriver driver;
    private String className = "VerifyAddItemtoCart";
    private String subid = "SH-367";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyAddItemtoCart(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyAddItemtoCart test = new VerifyAddItemtoCart(driver);
        test.runTest();
    }
}
