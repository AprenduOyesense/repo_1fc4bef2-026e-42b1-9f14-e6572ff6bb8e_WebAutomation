...
public class ValidateExactMatchSearchBehavior {

    private WebDriver driver;
    private String className = "ValidateExactMatchSearchBehavior";
    private String subid = "SH-464";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateExactMatchSearchBehavior(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateExactMatchSearchBehavior test = new ValidateExactMatchSearchBehavior(driver);
        test.runTest();
    }
}
