...
public class VerifyResponsiveDesignonDesktop {

    private WebDriver driver;
    private String className = "VerifyResponsiveDesignonDesktop";
    private String subid = "SH-263";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyResponsiveDesignonDesktop(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyResponsiveDesignonDesktop test = new VerifyResponsiveDesignonDesktop(driver);
        test.runTest();
    }
}
