...
public class ValidateEmptyCartMessage {

    private WebDriver driver;
    private String className = "ValidateEmptyCartMessage";
    private String subid = "SH-459";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateEmptyCartMessage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateEmptyCartMessage test = new ValidateEmptyCartMessage(driver);
        test.runTest();
    }
}
