...
public class SubscribeToNewsletter {
    ...
    private String className = "SubscribeToNewsletter";
    private String subid = "SH-132";

    // Constructor to initialize WebDriver and set className and subid
    public SubscribeToNewsletter(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SubscribeToNewsletter test = new SubscribeToNewsletter(driver);
        test.runTest();
    }
}
