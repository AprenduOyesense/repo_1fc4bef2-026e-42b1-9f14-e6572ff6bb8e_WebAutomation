...
public class UpdateUserInformation {
    ...
    private String className = "UpdateUserInformation";
    private String subid = "SH-135";

    // Constructor to initialize WebDriver and set className and subid
    public UpdateUserInformation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UpdateUserInformation test = new UpdateUserInformation(driver);
        test.runTest();
    }
}
