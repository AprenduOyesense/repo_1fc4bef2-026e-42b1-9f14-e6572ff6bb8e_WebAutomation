...
public class EnableNotifications {
    ...
    private String className = "EnableNotifications";
    private String subid = "SH-120";

    // Constructor to initialize WebDriver and set className and subid
    public EnableNotifications(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EnableNotifications test = new EnableNotifications(driver);
        test.runTest();
    }
}
