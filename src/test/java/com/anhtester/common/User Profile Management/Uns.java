...
public class UnsubscribeFromNewsletter {

    private WebDriver driver;
    private String className = "UnsubscribeFromNewsletter";
    private String subid = "SH-131";

    // Constructor to initialize WebDriver and set className and subid
    public UnsubscribeFromNewsletter(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UnsubscribeFromNewsletter test = new UnsubscribeFromNewsletter(driver);
        test.runTest();
    }
}
