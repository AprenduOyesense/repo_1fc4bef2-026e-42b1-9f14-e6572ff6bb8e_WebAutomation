...
public class VerifyViewSavedItems {

    private WebDriver driver;
    private String className = "VerifyViewSavedItems";
    private String subid = "SH-356";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyViewSavedItems(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyViewSavedItems test = new VerifyViewSavedItems(driver);
        test.runTest();
    }
}
