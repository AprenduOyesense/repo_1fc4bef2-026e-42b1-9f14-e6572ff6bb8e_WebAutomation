...
public class ConfirmWebsiteContent {

    private WebDriver driver;
    private String className = "ConfirmWebsiteContent";
    private String subid = "SH-390";

    // Constructor to initialize WebDriver and set className and subid
    public ConfirmWebsiteContent(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConfirmWebsiteContent test = new ConfirmWebsiteContent(driver);
        test.runTest();
    }
}
