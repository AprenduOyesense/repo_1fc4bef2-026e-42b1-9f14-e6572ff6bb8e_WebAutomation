...
public class CheckWebsiteDesign {

    private WebDriver driver;
    private String className = "CheckWebsiteDesign";
    private String subid = "SH-391";

    // Constructor to initialize WebDriver and set className and subid
    public CheckWebsiteDesign(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckWebsiteDesign test = new CheckWebsiteDesign(driver);
        test.runTest();
    }
}
