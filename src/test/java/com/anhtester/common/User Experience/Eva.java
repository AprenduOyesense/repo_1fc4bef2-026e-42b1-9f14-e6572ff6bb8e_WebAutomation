...
public class EvaluateWebsiteNavigation {

    private WebDriver driver;
    private String className = "EvaluateWebsiteNavigation";
    private String subid = "SH-392";

    // Constructor to initialize WebDriver and set className and subid
    public EvaluateWebsiteNavigation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EvaluateWebsiteNavigation test = new EvaluateWebsiteNavigation(driver);
        test.runTest();
    }
}
