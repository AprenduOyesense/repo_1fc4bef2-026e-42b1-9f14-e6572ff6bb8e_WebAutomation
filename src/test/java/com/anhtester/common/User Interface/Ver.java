...
public class VerifyLayoutConsistency {

    private WebDriver driver;
    private String className = "VerifyLayoutConsistency";
    private String subid = "SH-426";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyLayoutConsistency(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyLayoutConsistency test = new VerifyLayoutConsistency(driver);
        test.runTest();
    }
}
