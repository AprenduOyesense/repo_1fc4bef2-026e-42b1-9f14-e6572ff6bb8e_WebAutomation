...
public class CheckNavigationMenu {

    private WebDriver driver;
    private String className = "CheckNavigationMenu";
    private String subid = "SH-425";

    // Constructor to initialize WebDriver and set className and subid
    public CheckNavigationMenu(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckNavigationMenu test = new CheckNavigationMenu(driver);
        test.runTest();
    }
}
