...
public class ConfirmErrorMessages {

    private WebDriver driver;
    private String className = "ConfirmErrorMessages";
    private String subid = "SH-423";

    // Constructor to initialize WebDriver and set className and subid
    public ConfirmErrorMessages(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConfirmErrorMessages test = new ConfirmErrorMessages(driver);
        test.runTest();
    }
}
