...
public class ValidateImageDisplay {

    private WebDriver driver;
    private String className = "ValidateImageDisplay";
    private String subid = "SH-421";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateImageDisplay(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateImageDisplay test = new ValidateImageDisplay(driver);
        test.runTest();
    }
}
