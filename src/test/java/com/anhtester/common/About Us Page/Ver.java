...
public class VerifyAboutUsPageCompanyInformation {

    private WebDriver driver;
    private String className = "VerifyAboutUsPageCompanyInformation";
    private String subid = "SH-278";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyAboutUsPageCompanyInformation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyAboutUsPageCompanyInformation test = new VerifyAboutUsPageCompanyInformation(driver);
        test.runTest();
    }
}
