...
public class AddMultipleDifferentItemsToCart {

    private WebDriver driver;
    private String className = "AddMultipleDifferentItemsToCart";
    private String subid = "SH-461";

    // Constructor to initialize WebDriver and set className and subid
    public AddMultipleDifferentItemsToCart(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AddMultipleDifferentItemsToCart test = new AddMultipleDifferentItemsToCart(driver);
        test.runTest();
    }
}
