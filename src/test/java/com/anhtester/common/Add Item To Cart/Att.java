...
public class AttemptAddingSameItemMultipleTimes {

    private WebDriver driver;
    private String className = "AttemptAddingSameItemMultipleTimes";
    private String subid = "SH-462";

    // Constructor to initialize WebDriver and set className and subid
    public AttemptAddingSameItemMultipleTimes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AttemptAddingSameItemMultipleTimes test = new AttemptAddingSameItemMultipleTimes(driver);
        test.runTest();
    }
}
