...
public class SearchBooksByTitle {

    private WebDriver driver;
    private String className = "SearchBooksByTitle";
    private String subid = "SH-387";

    // Constructor to initialize WebDriver and set className and subid
    public SearchBooksByTitle(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SearchBooksByTitle test = new SearchBooksByTitle(driver);
        test.runTest();
    }
}
