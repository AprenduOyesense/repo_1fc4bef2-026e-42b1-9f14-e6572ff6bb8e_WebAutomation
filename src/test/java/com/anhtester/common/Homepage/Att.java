...
public class AttemptAddingItemToCartWhenOutOfStock {

    private WebDriver driver;
    private String className = "AttemptAddingItemToCartWhenOutOfStock";
    private String subid = "SH-388";

    // Constructor to initialize WebDriver and set className and subid
    public AttemptAddingItemToCartWhenOutOfStock(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AttemptAddingItemToCartWhenOutOfStock test = new AttemptAddingItemToCartWhenOutOfStock(driver);
        test.runTest();
    }
}
