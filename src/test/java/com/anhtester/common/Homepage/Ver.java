...
public class VerifyHomepageFooter {

    private WebDriver driver;
    private String className = "VerifyHomepageFooter";
    private String subid = "SH-351";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyHomepageFooter(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyHomepageFooter test = new VerifyHomepageFooter(driver);
        test.runTest();
    }
}
