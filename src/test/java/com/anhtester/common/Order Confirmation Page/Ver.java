...
public class VerifyOrderConfirmationPageBanner {

    private WebDriver driver;
    private String className = "VerifyOrderConfirmationPageBanner";
    private String subid = "SH-311";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyOrderConfirmationPageBanner(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyOrderConfirmationPageBanner test = new VerifyOrderConfirmationPageBanner(driver);
        test.runTest();
    }
}
