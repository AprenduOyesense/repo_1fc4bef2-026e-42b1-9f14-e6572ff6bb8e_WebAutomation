...
public class ViewBookReviews {

    private WebDriver driver;
    private String className = "ViewBookReviews";
    private String subid = "SH-510";

    // Constructor to initialize WebDriver and set className and subid
    public ViewBookReviews(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewBookReviews test = new ViewBookReviews(driver);
        test.runTest();
    }
}
