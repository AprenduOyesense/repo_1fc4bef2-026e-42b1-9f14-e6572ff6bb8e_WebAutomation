...
public class DeleteaBookReview {

    private WebDriver driver;
    private String className = "DeleteaBookReview";
    private String subid = "SH-507";

    // Constructor to initialize WebDriver and set className and subid
    public DeleteaBookReview(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        DeleteaBookReview test = new DeleteaBookReview(driver);
        test.runTest();
    }
}
