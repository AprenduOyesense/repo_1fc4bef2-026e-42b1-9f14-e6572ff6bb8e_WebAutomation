...
public class UpdateaBookReview {

    private WebDriver driver;
    private String className = "UpdateaBookReview";
    private String subid = "SH-508";

    // Constructor to initialize WebDriver and set className and subid
    public UpdateaBookReview(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UpdateaBookReview test = new UpdateaBookReview(driver);
        test.runTest();
    }
}
