...
public class AddaBookReview {

    private WebDriver driver;
    private String className = "AddaBookReview";
    private String subid = "SH-509";

    // Constructor to initialize WebDriver and set className and subid
    public AddaBookReview(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AddaBookReview test = new AddaBookReview(driver);
        test.runTest();
    }
}
