...
public class ViewBooksInAscendingOrderByTitle {

    private WebDriver driver;
    private String className = "ViewBooksInAscendingOrderByTitle";
    private String subid = "SH-465";

    // Constructor to initialize WebDriver and set className and subid
    public ViewBooksInAscendingOrderByTitle(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewBooksInAscendingOrderByTitle test = new ViewBooksInAscendingOrderByTitle(driver);
        test.runTest();
    }
}
