...
public class ManageSalesTax {

    private WebDriver driver;
    private String className = "ManageSalesTax";
    private String subid = "SH-491";

    // Constructor to initialize WebDriver and set className and subid
    public ManageSalesTax(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ManageSalesTax test = new ManageSalesTax(driver);
        test.runTest();
    }
}
