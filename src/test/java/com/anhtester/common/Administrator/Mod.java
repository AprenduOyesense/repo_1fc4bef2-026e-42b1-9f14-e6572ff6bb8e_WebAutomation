...
public class ModifyaBook {

    private WebDriver driver;
    private String className = "ModifyaBook";
    private String subid = "SH-498";

    // Constructor to initialize WebDriver and set className and subid
    public ModifyaBook(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ModifyaBook test = new ModifyaBook(driver);
        test.runTest();
    }
}
