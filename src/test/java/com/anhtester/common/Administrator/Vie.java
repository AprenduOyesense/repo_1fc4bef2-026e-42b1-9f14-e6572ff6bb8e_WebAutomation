...
public class ViewUserDetails {
    ...
    private String className = "ViewUserDetails";
    private String subid = "SH-496";

    // Constructor to initialize WebDriver and set className and subid
    public ViewUserDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewUserDetails test = new ViewUserDetails(driver);
        test.runTest();
    }
}
