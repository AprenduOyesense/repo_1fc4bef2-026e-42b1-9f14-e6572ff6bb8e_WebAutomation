...
public class VerifyOrderHistoryPageOrderFiltering {

    private WebDriver driver;
    private String className = "VerifyOrderHistoryPageOrderFiltering";
    private String subid = "SH-300";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyOrderHistoryPageOrderFiltering(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyOrderHistoryPageOrderFiltering test = new VerifyOrderHistoryPageOrderFiltering(driver);
        test.runTest();
    }
}
