...
public class VerifyMobileCompatibility {

    private WebDriver driver;
    private String className = "VerifyMobileCompatibility";
    private String subid = "SH-385";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyMobileCompatibility(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyMobileCompatibility test = new VerifyMobileCompatibility(driver);
        test.runTest();
    }
}
