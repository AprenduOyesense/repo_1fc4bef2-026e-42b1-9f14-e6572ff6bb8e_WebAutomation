...
public class TestUserFeedback {
    ...
    private String className = "TestUserFeedback";
    private String subid = "SH-384";

    // Constructor to initialize WebDriver and set className and subid
    public TestUserFeedback(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        TestUserFeedback test = new TestUserFeedback(driver);
        test.runTest();
    }
}
