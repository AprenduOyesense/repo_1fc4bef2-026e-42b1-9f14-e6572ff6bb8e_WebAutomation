...
public class ValidateAccessibilityCompliance {

    private WebDriver driver;
    private String className = "ValidateAccessibilityCompliance";
    private String subid = "SH-386";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateAccessibilityCompliance(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateAccessibilityCompliance test = new ValidateAccessibilityCompliance(driver);
        test.runTest();
    }
}
