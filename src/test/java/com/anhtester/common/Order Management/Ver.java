...
public class VerifyOrderCancellation {

    private WebDriver driver;
    private String className = "VerifyOrderCancellation";
    private String subid = "SH-360";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyOrderCancellation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyOrderCancellation test = new VerifyOrderCancellation(driver);
        test.runTest();
    }
}
