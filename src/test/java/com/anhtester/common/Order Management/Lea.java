...
public class LeaveProductReview {

    private WebDriver driver;
    private String className = "LeaveProductReview";
    private String subid = "SH-158";

    // Constructor to initialize WebDriver and set className and subid
    public LeaveProductReview(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        LeaveProductReview test = new LeaveProductReview(driver);
        test.runTest();
    }
}
