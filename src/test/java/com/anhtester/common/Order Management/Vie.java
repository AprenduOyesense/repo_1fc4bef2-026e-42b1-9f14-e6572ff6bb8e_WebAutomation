...
public class ViewOrderTracking {

    private WebDriver driver;
    private String className = "ViewOrderTracking";
    private String subid = "SH-146";

    // Constructor to initialize WebDriver and set className and subid
    public ViewOrderTracking(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ViewOrderTracking test = new ViewOrderTracking(driver);
        test.runTest();
    }
}
