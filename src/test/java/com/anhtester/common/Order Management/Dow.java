...
public class DownloadInvoice {
    ...
    private String className = "DownloadInvoice";
    private String subid = "SH-161";

    // Constructor to initialize WebDriver and set className and subid
    public DownloadInvoice(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        DownloadInvoice test = new DownloadInvoice(driver);
        test.runTest();
    }
}
