...
public class CheckSessionTimeout {
    ...
    private String className = "CheckSessionTimeout";
    private String subid = "SH-466";

    // Constructor to initialize WebDriver and set className and subid
    public CheckSessionTimeout(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckSessionTimeout test = new CheckSessionTimeout(driver);
        test.runTest();
    }
}
