...
public class ConfirmLogoutFunctionality {

    private WebDriver driver;
    private String className = "ConfirmLogoutFunctionality";
    private String subid = "SH-467";

    // Constructor to initialize WebDriver and set className and subid
    public ConfirmLogoutFunctionality(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConfirmLogoutFunctionality test = new ConfirmLogoutFunctionality(driver);
        test.runTest();
    }
}
