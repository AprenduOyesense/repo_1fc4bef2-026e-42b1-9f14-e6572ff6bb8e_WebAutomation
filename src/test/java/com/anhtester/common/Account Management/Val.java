...
public class ValidateUniqueUsername {

    private WebDriver driver;
    private String className = "ValidateUniqueUsername";
    private String subid = "SH-434";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateUniqueUsername(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateUniqueUsername test = new ValidateUniqueUsername(driver);
        test.runTest();
    }
}
