...
public class UpdateAccountDetails {
    ...
    private String className = "UpdateAccountDetails";
    private String subid = "SH-433";

    // Constructor to initialize WebDriver and set className and subid
    public UpdateAccountDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UpdateAccountDetails test = new UpdateAccountDetails(driver);
        test.runTest();
    }
}
