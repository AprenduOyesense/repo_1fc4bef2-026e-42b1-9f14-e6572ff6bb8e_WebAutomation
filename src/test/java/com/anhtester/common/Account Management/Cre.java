...
public class CreateCustomerAccount {
    ...
    private String className = "CreateCustomerAccount";
    private String subid = "SH-435";

    // Constructor to initialize WebDriver and set className and subid
    public CreateCustomerAccount(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CreateCustomerAccount test = new CreateCustomerAccount(driver);
        test.runTest();
    }
}
