...
public class VerifyCheckoutPageShippingInformation {

    private WebDriver driver;
    private String className = "VerifyCheckoutPageShippingInformation";
    private String subid = "SH-316";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyCheckoutPageShippingInformation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyCheckoutPageShippingInformation test = new VerifyCheckoutPageShippingInformation(driver);
        test.runTest();
    }
}
