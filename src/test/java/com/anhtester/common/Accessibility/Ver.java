...
public class VerifyColorContrast {

    private WebDriver driver;
    private String className = "VerifyColorContrast";
    private String subid = "SH-409";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyColorContrast(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyColorContrast test = new VerifyColorContrast(driver);
        test.runTest();
    }
}
