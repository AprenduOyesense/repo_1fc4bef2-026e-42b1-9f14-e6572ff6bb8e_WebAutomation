...
public class CheckKeyboardNavigation {

    private WebDriver driver;
    private String className = "CheckKeyboardNavigation";
    private String subid = "SH-410";

    // Constructor to initialize WebDriver and set className and subid
    public CheckKeyboardNavigation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckKeyboardNavigation test = new CheckKeyboardNavigation(driver);
        test.runTest();
    }
}
