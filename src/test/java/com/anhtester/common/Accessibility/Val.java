...
public class ValidateScreenReaderCompatibility {

    private WebDriver driver;
    private String className = "ValidateScreenReaderCompatibility";
    private String subid = "SH-411";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateScreenReaderCompatibility(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateScreenReaderCompatibility test = new ValidateScreenReaderCompatibility(driver);
        test.runTest();
    }
}
