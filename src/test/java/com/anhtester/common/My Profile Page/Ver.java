...
public class VerifyMyProfilePagePasswordChange {

    private WebDriver driver;
    private String className = "VerifyMyProfilePagePasswordChange";
    private String subid = "SH-293";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyMyProfilePagePasswordChange(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyMyProfilePagePasswordChange test = new VerifyMyProfilePagePasswordChange(driver);
        test.runTest();
    }
}
