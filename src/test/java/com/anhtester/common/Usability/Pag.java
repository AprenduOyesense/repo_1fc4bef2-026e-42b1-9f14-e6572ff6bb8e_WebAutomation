...
public class PageLoadSpeed {

    private WebDriver driver;
    private String className = "PageLoadSpeed";
    private String subid = "SH-472";

    // Constructor to initialize WebDriver and set className and subid
    public PageLoadSpeed(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        PageLoadSpeed test = new PageLoadSpeed(driver);
        test.runTest();
    }
}
