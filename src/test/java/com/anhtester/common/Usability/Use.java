...
public class UserProfileUsability {

    private WebDriver driver;
    private String className = "UserProfileUsability";
    private String subid = "SH-478";

    // Constructor to initialize WebDriver and set className and subid
    public UserProfileUsability(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UserProfileUsability test = new UserProfileUsability(driver);
        test.runTest();
    }
}
