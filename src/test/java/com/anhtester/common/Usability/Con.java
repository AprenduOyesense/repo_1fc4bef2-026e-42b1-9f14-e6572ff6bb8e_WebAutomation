...
public class ContentClarity {

    private WebDriver driver;
    private String className = "ContentClarity";
    private String subid = "SH-474";

    // Constructor to initialize WebDriver and set className and subid
    public ContentClarity(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ContentClarity test = new ContentClarity(driver);
        test.runTest();
    }
}
