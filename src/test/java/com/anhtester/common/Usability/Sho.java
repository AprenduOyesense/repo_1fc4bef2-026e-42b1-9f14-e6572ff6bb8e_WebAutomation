...
public class ShoppingCartUsability {

    private WebDriver driver;
    private String className = "ShoppingCartUsability";
    private String subid = "SH-479";

    // Constructor to initialize WebDriver and set className and subid
    public ShoppingCartUsability(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ShoppingCartUsability test = new ShoppingCartUsability(driver);
        test.runTest();
    }
}
