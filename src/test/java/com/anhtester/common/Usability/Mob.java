...
public class MobileResponsiveness {
    ...
    private String className = "MobileResponsiveness";
    private String subid = "SH-475";

    // Constructor to initialize WebDriver and set className and subid
    public MobileResponsiveness(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        MobileResponsiveness test = new MobileResponsiveness(driver);
        test.runTest();
    }
}
