...
public class VerifyBlogPagePostCommenting {

    private WebDriver driver;
    private String className = "VerifyBlogPagePostCommenting";
    private String subid = "SH-271";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyBlogPagePostCommenting(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyBlogPagePostCommenting test = new VerifyBlogPagePostCommenting(driver);
        test.runTest();
    }
}
