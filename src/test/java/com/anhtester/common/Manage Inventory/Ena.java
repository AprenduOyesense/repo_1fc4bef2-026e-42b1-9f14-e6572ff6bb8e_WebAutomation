...
public class EnableStopOrder {

    private WebDriver driver;
    private String className = "EnableStopOrder";
    private String subid = "SH-442";

    // Constructor to initialize WebDriver and set className and subid
    public EnableStopOrder(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EnableStopOrder test = new EnableStopOrder(driver);
        test.runTest();
    }
}
