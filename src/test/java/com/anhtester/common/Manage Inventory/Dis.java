...
public class DisableStopOrder {

    private WebDriver driver;
    private String className = "DisableStopOrder";
    private String subid = "SH-441";

    // Constructor to initialize WebDriver and set className and subid
    public DisableStopOrder(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        DisableStopOrder test = new DisableStopOrder(driver);
        test.runTest();
    }
}
