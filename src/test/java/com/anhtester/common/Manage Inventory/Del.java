...
public class DeleteExistingBook {

    private WebDriver driver;
    private String className = "DeleteExistingBook";
    private String subid = "SH-445";

    // Constructor to initialize WebDriver and set className and subid
    public DeleteExistingBook(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        DeleteExistingBook test = new DeleteExistingBook(driver);
        test.runTest();
    }
}
