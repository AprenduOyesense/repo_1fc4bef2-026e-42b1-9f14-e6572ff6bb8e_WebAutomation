...
public class SetReorderThreshold {

    private WebDriver driver;
    private String className = "SetReorderThreshold";
    private String subid = "SH-443";

    // Constructor to initialize WebDriver and set className and subid
    public SetReorderThreshold(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SetReorderThreshold test = new SetReorderThreshold(driver);
        test.runTest();
    }
}
