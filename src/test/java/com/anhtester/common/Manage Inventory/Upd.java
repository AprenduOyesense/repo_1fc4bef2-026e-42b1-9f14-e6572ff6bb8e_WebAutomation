...
public class UpdateStockQuantity {
    ...
    private String className = "UpdateStockQuantity";
    private String subid = "SH-444";

    // Constructor to initialize WebDriver and set className and subid
    public UpdateStockQuantity(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UpdateStockQuantity test = new UpdateStockQuantity(driver);
        test.runTest();
    }
}
