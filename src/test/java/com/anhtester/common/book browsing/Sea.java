...
public class SearchBooksbyAuthor {
    ...
    private String className = "SearchBooksbyAuthor";
    private String subid = "SH-469";

    // Constructor to initialize WebDriver and set className and subid
    public SearchBooksbyAuthor(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SearchBooksbyAuthor test = new SearchBooksbyAuthor(driver);
        test.runTest();
    }
}
