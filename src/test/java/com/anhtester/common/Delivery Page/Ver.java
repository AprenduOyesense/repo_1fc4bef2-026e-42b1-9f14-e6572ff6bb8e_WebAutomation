...
public class VerifyDeliveryPageFAQs {

    private WebDriver driver;
    private String className = "VerifyDeliveryPageFAQs";
    private String subid = "SH-327";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyDeliveryPageFAQs(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyDeliveryPageFAQs test = new VerifyDeliveryPageFAQs(driver);
        test.runTest();
    }
}
