...
public class CrossSiteScripting(XSS)Protection {

    private WebDriver driver;
    private String className = "CrossSiteScripting(XSS)Protection";
    private String subid = "SH-483";

    // Constructor to initialize WebDriver and set className and subid
    public CrossSiteScripting(XSS)Protection(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CrossSiteScripting(XSS)Protection test = new CrossSiteScripting(XSS)Protection(driver);
        test.runTest();
    }
}
