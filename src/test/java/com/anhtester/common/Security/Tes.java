...
public class TestAuthenticationMechanism {
    ...
    private String className = "TestAuthenticationMechanism";
    private String subid = "SH-413";

    // Constructor to initialize WebDriver and set className and subid
    public TestAuthenticationMechanism(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        TestAuthenticationMechanism test = new TestAuthenticationMechanism(driver);
        test.runTest();
    }
}
