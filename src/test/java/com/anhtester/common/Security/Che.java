...
public class CheckCrossSiteScripting(XSS)Prevention {

    private WebDriver driver;
    private String className = "CheckCrossSiteScripting(XSS)Prevention";
    private String subid = "SH-415";

    // Constructor to initialize WebDriver and set className and subid
    public CheckCrossSiteScripting(XSS)Prevention(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckCrossSiteScripting(XSS)Prevention test = new CheckCrossSiteScripting(XSS)Prevention(driver);
        test.runTest();
    }
}
