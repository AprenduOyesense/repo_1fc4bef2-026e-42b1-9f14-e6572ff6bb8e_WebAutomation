...
public class SQLInjectionProtection {
    ...
    private String className = "SQLInjectionProtection";
    private String subid = "SH-482";

    // Constructor to initialize WebDriver and set className and subid
    public SQLInjectionProtection(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SQLInjectionProtection test = new SQLInjectionProtection(driver);
        test.runTest();
    }
}
