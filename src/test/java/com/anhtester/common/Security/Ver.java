...
public class VerifyDataEncryption {

    private WebDriver driver;
    private String className = "VerifyDataEncryption";
    private String subid = "SH-251";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyDataEncryption(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyDataEncryption test = new VerifyDataEncryption(driver);
        test.runTest();
    }
}
