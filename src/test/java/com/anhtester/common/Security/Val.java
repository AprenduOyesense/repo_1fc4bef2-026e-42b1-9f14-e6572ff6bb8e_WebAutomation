...
public class ValidateSQLInjectionProtection {

    private WebDriver driver;
    private String className = "ValidateSQLInjectionProtection";
    private String subid = "SH-414";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateSQLInjectionProtection(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateSQLInjectionProtection test = new ValidateSQLInjectionProtection(driver);
        test.runTest();
    }
}
