...
public class AttemptInvalidPromotionCode {

    private WebDriver driver;
    private String className = "AttemptInvalidPromotionCode";
    private String subid = "SH-455";

    // Constructor to initialize WebDriver and set className and subid
    public AttemptInvalidPromotionCode(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AttemptInvalidPromotionCode test = new AttemptInvalidPromotionCode(driver);
        test.runTest();
    }
}
