...
public class EnterPromotionCode {

    private WebDriver driver;
    private String className = "EnterPromotionCode";
    private String subid = "SH-456";

    // Constructor to initialize WebDriver and set className and subid
    public EnterPromotionCode(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EnterPromotionCode test = new EnterPromotionCode(driver);
        test.runTest();
    }
}
