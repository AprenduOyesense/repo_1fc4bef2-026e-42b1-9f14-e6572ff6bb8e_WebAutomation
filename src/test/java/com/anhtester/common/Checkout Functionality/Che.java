...
public class CheckCheckoutPageElements {

    private WebDriver driver;
    private String className = "CheckCheckoutPageElements";
    private String subid = "SH-457";

    // Constructor to initialize WebDriver and set className and subid
    public CheckCheckoutPageElements(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckCheckoutPageElements test = new CheckCheckoutPageElements(driver);
        test.runTest();
    }
}
