...
public class ApplyOnePromotionCodePerOrder {

    private WebDriver driver;
    private String className = "ApplyOnePromotionCodePerOrder";
    private String subid = "SH-454";

    // Constructor to initialize WebDriver and set className and subid
    public ApplyOnePromotionCodePerOrder(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ApplyOnePromotionCodePerOrder test = new ApplyOnePromotionCodePerOrder(driver);
        test.runTest();
    }
}
