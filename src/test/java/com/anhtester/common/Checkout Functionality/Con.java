...
public class ConfirmOrderDetails {
    ...
    private String className = "ConfirmOrderDetails";
    private String subid = "SH-450";

    // Constructor to initialize WebDriver and set className and subid
    public ConfirmOrderDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConfirmOrderDetails test = new ConfirmOrderDetails(driver);
        test.runTest();
    }
}
