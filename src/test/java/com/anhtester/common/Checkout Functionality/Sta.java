...
public class StartCheckoutProcedure {

    private WebDriver driver;
    private String className = "StartCheckoutProcedure";
    private String subid = "SH-458";

    // Constructor to initialize WebDriver and set className and subid
    public StartCheckoutProcedure(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        StartCheckoutProcedure test = new StartCheckoutProcedure(driver);
        test.runTest();
    }
}
