...
public class VerifyDealsPageBanner {

    private WebDriver driver;
    private String className = "VerifyDealsPageBanner";
    private String subid = "SH-338";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyDealsPageBanner(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyDealsPageBanner test = new VerifyDealsPageBanner(driver);
        test.runTest();
    }
}
