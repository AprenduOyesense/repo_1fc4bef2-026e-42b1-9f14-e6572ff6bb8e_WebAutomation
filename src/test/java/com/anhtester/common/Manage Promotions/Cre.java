...
public class CreatePromotion {
    ...
    private String className = "CreatePromotion";
    private String subid = "SH-440";

    // Constructor to initialize WebDriver and set className and subid
    public CreatePromotion(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CreatePromotion test = new CreatePromotion(driver);
        test.runTest();
    }
}
