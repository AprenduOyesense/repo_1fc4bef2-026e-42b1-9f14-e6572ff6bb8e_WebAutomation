...
public class UpdatePromotionDetails {

    private WebDriver driver;
    private String className = "UpdatePromotionDetails";
    private String subid = "SH-439";

    // Constructor to initialize WebDriver and set className and subid
    public UpdatePromotionDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        UpdatePromotionDetails test = new UpdatePromotionDetails(driver);
        test.runTest();
    }
}
