...
public class VerifyPromotionExpiration {

    private WebDriver driver;
    private String className = "VerifyPromotionExpiration";
    private String subid = "SH-436";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyPromotionExpiration(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyPromotionExpiration test = new VerifyPromotionExpiration(driver);
        test.runTest();
    }
}
