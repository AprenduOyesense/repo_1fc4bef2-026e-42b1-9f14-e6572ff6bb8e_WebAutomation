...
public class CheckPromotionEmail {

    private WebDriver driver;
    private String className = "CheckPromotionEmail";
    private String subid = "SH-437";

    // Constructor to initialize WebDriver and set className and subid
    public CheckPromotionEmail(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckPromotionEmail test = new CheckPromotionEmail(driver);
        test.runTest();
    }
}
