...
public class DeletePromotion {
    ...
    private String className = "DeletePromotion";
    private String subid = "SH-438";

    // Constructor to initialize WebDriver and set className and subid
    public DeletePromotion(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        DeletePromotion test = new DeletePromotion(driver);
        test.runTest();
    }
}
