...
public class LoginwithInvalidCredentials {
    ...
    private String className = "LoginwithInvalidCredentials";
    private String subid = "SH-519";
    ...
    public static void main(String[] args) {
        ...
        LoginwithInvalidCredentials test = new LoginwithInvalidCredentials(driver);
        test.runTest();
    }
}
